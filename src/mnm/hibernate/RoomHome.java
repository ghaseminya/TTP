...
public class RoomHome {
	...
	public Room merge(Room detachedInstance) {
		...
		try {
			Room result = (Room) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Room findById(int id) {
		...
		try {
			Room instance = (Room) sessionFactory.getCurrentSession().get(
					"Room", id);
			if (instance == null) {
	...
	public List<Room> findByExample(Room instance) {
		...
		try {
			List<Room> results = (List<Room>) sessionFactory
					.getCurrentSession().createCriteria("Room").add(
