...
public class ResultHome {
	...
	private static final Log log = LogFactory.getLog(ResultHome.class);
	...
	public Result merge(Result detachedInstance) {
		...
		try {
			Result result = (Result) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Result findById(java.lang.Integer id) {
		...
		try {
			Result instance = (Result) sessionFactory.getCurrentSession().get(
					"Result", id);
			if (instance == null) {
	...
	public List<Result> findByExample(Result instance) {
		log.debug("finding Result instance by example");
		try {
			List<Result> results = (List<Result>) sessionFactory
					.getCurrentSession().createCriteria("Result").add(
